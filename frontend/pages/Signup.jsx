            ...
            <div className='border h-screen w-screen flex align-middle items-center justify-center'>
                <div className='border-2 h-[500px] w-[400px] rounded-lg'>
                    <div className='h-[100px] w-[400px] flex'>
                        <h1 className='flex text-3xl items-center align-middle justify-center w-[400px] font-bold'>Todo</h1>
                    </div>
                    <div className='h-[400px] w-[400px]'>
                        ...
                        <button className='border mt-8 h-[50px] text-2xl rounded-md align-middle justify-center font-semibold bg-blue-950 text-white '>Sign Up</button>
                        <p className='text-center mt-2'>Have an account? <a href="">Sign In</a></p>
